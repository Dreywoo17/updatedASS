...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2025 at 02:37 PM
...
CREATE TABLE `appointmentdb` (
  ...
  `Completion_Remark` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `appointmentdb` (`ID`, `student_ID`, `student_name`, `teacher_name`, `department_name`, `section`, `appointment_date`, `Description`, `Status`, `user_ID`, `user_type`, `Cancellation_Remark`, `Completion_Remark`) VALUES
(56, '1@g.cu.edu.ph', 'Andriemer S. Bonggo', 'lawas', 'Education', 'B', '2025-04-27 20:25:00', 'I am struggling with my project', 'Cancelled', 0, 'student', 'I busy today. Sorry.', NULL),
(57, '1@g.cu.edu.ph', 'Andriemer S. Bonggo', 'lawas', 'Education', 'B', '2025-04-28 12:00:00', 'Programming', 'Completed', 0, 'student', NULL, NULL);
